...
use wt_api::{AgentGitReport, ApiRequest, Operation, Response};
use wt_cli::config::ClientConfig;
use wt_cli::transport::{self, ContextError};
...
mod tests {
    use super::*;
    use uuid::Uuid;
    use wt_api::{AgentGitReport, AgentGitReportKind, InstanceName};
