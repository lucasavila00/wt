...
Host file, command, and SSH credential handling comes from `wt-setup-core`.
Proxy request handling stays in `wt-git-proxy`.

Install and operation: [wt-git-proxy](../wt-git-proxy/README.md).
