...
pub const SERVER_USER: &str = wt_guest::WT_IDENTITY.user;
pub const SERVER_GROUP: &str = wt_guest::WT_IDENTITY.group;
pub const SERVER_UID: u32 = wt_guest::WT_IDENTITY.uid;
pub const SERVER_GID: u32 = wt_guest::WT_IDENTITY.gid;
pub const SERVER_HOME: &str = wt_guest::WT_IDENTITY.home;
