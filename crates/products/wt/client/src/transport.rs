...
mod tests {
    ...
    fn pane_observation_response_rejects_unknown_fields_at_every_level() {
        ...
        let valid = br#"{"protocol_version":15,"outcome":"ok","response":{"response":"pane_observations","panes":[{"world_id":"123e4567-e89b-12d3-a456-426614174000","world_name":"host","created_at_unix_ms":0,"tmux_session":"wt-host","pane_id":"%1","changed_at_unix_ms":1,"observed_at_unix_ms":2}]}}"#;
        ...
        for invalid in [
            ...
            br#"{"protocol_version":15,"outcome":"ok","response":{"response":"pane_observations","panes":[],"extra":true}}"#.as_slice(),
            br#"{"protocol_version":15,"outcome":"ok","response":{"response":"pane_observations","panes":[{"world_id":"123e4567-e89b-12d3-a456-426614174000","world_name":"host","created_at_unix_ms":0,"tmux_session":"wt-host","pane_id":"%1","changed_at_unix_ms":1,"observed_at_unix_ms":2,"extra":true}]}}"#.as_slice(),
