...
mod tests {
    ...
    #[test]
    fn pane_render_requires_window_metadata() {
        let context = Context {
            name: "local".into(),
            kind: ContextKind::BareMetalLocal,
        };
        let missing = br#"{"protocol_version":21,"outcome":"ok","response":{"response":"pane_observations","panes":[{"world_id":"123e4567-e89b-12d3-a456-426614174000","world_name":"host","created_at_unix_ms":0,"tmux_session":"wt-host","pane_id":"%1","cwd":"/home/wt","changed_at_unix_ms":1,"observed_at_unix_ms":2,"render":{"frame":{"rows":1,"columns":1,"cells":[{"text":"C"}]}}}]}}"#;
