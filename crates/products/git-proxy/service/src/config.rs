...
impl ProxyConfig {
    ...
    pub(crate) fn policy(&self) -> Result<wt_git_smart_protocol::WritePolicy> {
        wt_git_smart_protocol::WritePolicy::new(
    ...
    pub(crate) fn resolve_command(
        &self,
        command: &str,
    ) -> Result<(wt_git_smart_protocol::GitService, &ProviderConfig, String)> {
        for service in [
            wt_git_smart_protocol::GitService::UploadPack,
            wt_git_smart_protocol::GitService::ReceivePack,
        ] {
