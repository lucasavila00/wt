...
fn shows_the_open_pull_request_for_an_explicit_branch() {
    ...
    {"type":"change_request","data":{"handle":"7","url":"https://github.test/acme/widget/pull/7","title":"Fix login","body":"Fixes the login flow.","state":"open","draft":false,"head":"abc123","base":"main","conflict_state":"pending","review_state":null,"threads":[],"jobs":[]}}
    "###);
