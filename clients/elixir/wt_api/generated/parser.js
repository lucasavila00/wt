...
const direct_hoist_50 = new ConstRuntype(undefined, "read_world_mail");
...
const direct_hoist_52 = new ArrayRuntype(undefined, direct_hoist_13);
const direct_hoist_53 = new ObjectRuntype(undefined, {
    "high_water_message_id": direct_hoist_25,
    "messages": direct_hoist_52
}, []);
...
const direct_hoist_57 = new ConstRuntype(undefined, "resume_codex");
const direct_hoist_58 = new ObjectRuntype(undefined, {
    "api_version": direct_hoist_28,
    "context": direct_hoist_29,
    "expected_server_id": new OptionalFieldRuntype(direct_hoist_30),
    "operation": direct_hoist_57,
    "request_id": direct_hoist_30,
    "thread_id": direct_hoist_29,
    "world_id": direct_hoist_30
}, []);
const direct_hoist_59 = new ConstRuntype(undefined, "send_codex_message");
...
const direct_hoist_62 = new ObjectRuntype(undefined, {
    "delivery": direct_hoist_61,
    "thread_id": direct_hoist_29,
    "turn_id": direct_hoist_29
}, []);
const direct_hoist_63 = new ArrayRuntype(undefined, direct_hoist_29);
const direct_hoist_64 = new RefRuntype(undefined, "UInt16");
const direct_hoist_65 = new ObjectRuntype(undefined, {
    "host": direct_hoist_29,
    "host_keys": direct_hoist_63,
    "port": direct_hoist_64,
    "user": direct_hoist_29
}, []);
const direct_hoist_66 = new ConstRuntype(undefined, "start_codex");
const direct_hoist_67 = new ObjectRuntype(undefined, {
    "api_version": direct_hoist_28,
    "context": direct_hoist_29,
    "expected_server_id": new OptionalFieldRuntype(direct_hoist_30),
    "message": direct_hoist_29,
    "operation": direct_hoist_66,
    "request_id": direct_hoist_30,
    "world_id": direct_hoist_30
}, []);
...
const direct_hoist_69 = new ConstRuntype(undefined, "steer_codex");
...
const direct_hoist_71 = new ConstRuntype(undefined, "ok");
const direct_hoist_72 = new RefRuntype(undefined, "Result");
const direct_hoist_73 = new ObjectRuntype(undefined, {
    "api_version": direct_hoist_28,
    "expires_at_unix_ms": new OptionalFieldRuntype(direct_hoist_40),
    "outcome": direct_hoist_71,
    "request_id": direct_hoist_30,
    "result": direct_hoist_72,
    "server_id": direct_hoist_30
}, []);
const direct_hoist_74 = new NumberWithFormatRuntype(undefined, [
    "UInt16"
]);
const direct_hoist_75 = new NumberWithFormatRuntype(undefined, [
    "UInt32"
]);
const direct_hoist_76 = new NumberWithFormatRuntype(undefined, [
    "UInt64"
]);
const direct_hoist_77 = new StringWithFormatRuntype(undefined, [
    "Uuid"
]);
...
const namedRuntypes = {
    ...
    "ReadWorldMailRequest": direct_hoist_51,
    "ReadWorldMailResult": direct_hoist_53,
    "Request": direct_hoist_54,
    "Response": direct_hoist_55,
    "Result": direct_hoist_56,
    "ResumeCodexRequest": direct_hoist_58,
    "SendCodexMessageRequest": direct_hoist_60,
    "SendCodexMessageResult": direct_hoist_62,
    "SshAccess": direct_hoist_65,
    "StartCodexRequest": direct_hoist_67,
    "StartCodexResult": direct_hoist_68,
    "SteerCodexRequest": direct_hoist_70,
    "SuccessResponse": direct_hoist_73,
    "UInt16": direct_hoist_74,
    "UInt32": direct_hoist_75,
    "UInt64": direct_hoist_76,
    "Uuid": direct_hoist_77,
    "World": direct_hoist_79,
    "WorldMail": direct_hoist_81
};
