...
Controllers install and supervise their agent runtimes through `exec_world`.
Long-running installation jobs and services must use a guest process supervisor;
each execution request has a 60-second deadline.
