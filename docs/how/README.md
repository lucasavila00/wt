...
client: wt + OpenSSH
   ...
   └─ ssh SERVER ───────────┤
                     ...
                     wt-server daemon
                       ...
                       └─ wt-devcontainer lifecycle
                          ├─ wt-provider + wt-libvirt
...
| `wt-provider` | Provider-neutral machine lifecycle and guest transport |
| `wt-libvirt` | KVM machine creation, inspection, destruction, and QEMU guest-agent transport |
| `wt-devcontainer` | Devcontainer bootstrap, provisioning, inspection, and lifecycle |
