...
The golden image contains OpenSSH, Byobu, tmux, Codex, Diffo, and WT's static
Git, agent-tool, and Codex-integration executables. World creation only applies
identity and access state; it does not transfer executables, execute a user
recipe, or install application packages.
