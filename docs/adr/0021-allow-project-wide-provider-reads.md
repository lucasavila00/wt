...
directly identifies the provider object.

As the first application of this policy, `ag-git log job JOB` accepts any numeric
...
- Job URLs are not an input format; callers pass the numeric job ID shown in
  the URL.
