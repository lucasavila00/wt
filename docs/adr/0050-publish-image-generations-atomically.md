...
The installer currently moves the image first and its manifest second. If the
process stops between those moves, the server can use a new image with an old
manifest.
