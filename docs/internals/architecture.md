...
protected server socket. Protocol version 7 carries host-world resources, a
Git author, server information, context-local Codex session observations, and
streamed creation progress events.
